...
long Calculate(List<long> inputList)
{
    if (inputList.Count == 3)
    {
        ...
        if (inputList[1] * inputList[2] == inputList[0]) return inputList[0];
        return long.Parse($"{inputList[1]}{inputList[2]}");
    }
    else
    {
        ...
        listMul.RemoveAt(2);
        if (Calculate(listMul) == inputList[0]) return inputList[0];
        
        var listCnc = inputList.ToList();
        listCnc[1] = long.Parse($"{inputList[1]}{inputList[2]}");
        listCnc.RemoveAt(2);
        return Calculate(listCnc);
    }
}